  ...
  return (
    <section className="h-[100vh] overflow-hidden">
      <div className=" h-full w-full flex items-center relative py-16 md:py-0 bg-[#FE9D2C]">
        ...
        {/* Decorative Elements */}
        <div className="absolute top-20 left-10 w-12 h-12 md:w-20 md:h-20 rounded-full bg-[#fffff0]   animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-20 h-20 md:w-32 md:h-32 rounded-full bg-[#fffff0]  animate-bounce"></div>
        ...
        <div className="lg:max-w-[1300px] w-full mx-auto px-4 sm:px-6 lg:px-8 pt-16 md:pt-20 z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="w-full md:w-1/2 mb-8 md:mb-2 mx-5">
              ...
              <p className="text-base sm:text-lg text-black mb-6 max-w-md italic rounded-lg">
